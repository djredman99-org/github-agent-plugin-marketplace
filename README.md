...
4. Use the `.github/agents/` and `.github/skills/` definitions as blueprints when building your own agent plugins.
5. Embed instruction files from `.github/instructions/` into custom agent system prompts to tune behaviour.
